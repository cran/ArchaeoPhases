...
output:
  html_document:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{ArchaeoPhases-groups}
...
For a description of the statiscal aspects of the functions implemented in ArchaeoPhases version 1.4 :  
Anne Philippe, Marie-Anne Vibet. (2020). Analysis of Archaeological Phases using the CRAN Package 'ArchaeoPhases'. . Journal of Statistical Software, Code Snippets, 93, 1--25.
